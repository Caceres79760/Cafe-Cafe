  ...
  return (
    <div style={{marginBottom:12}}>
      <div style={{display:'flex',alignItems:'center',gap:6,marginBottom:6}}>
        ...
        <span style={{fontSize:13,fontWeight:700,color:'var(--text-1)'}}>{value}<span style={{fontSize:11,fontWeight:400,color:'var(--text-3)' }}>/5</span></span>
      </div>
    ...
    <div style={{position:'fixed',inset:0,background:'rgba(180,165,145,0.88)',display:'flex',alignItems:'center',justifyContent:'center',zIndex:9999,padding:24}}
      ...
      <div className="card animate-scaleIn" style={{width:'100%',maxWidth:400,padding:'32px 28px'}}>
        <div style={{textAlign:'center',marginBottom:28}}>
          <h1 style={{fontFamily:"'Cormorant Garamond',serif",fontSize:32,fontWeight:700,fontStyle:'italic',color:'var(--text-1)'}}>Café Café</h1>
      ...
      <div className="animate-slideUp" style={{background:'var(--surface)',borderRadius:'20px 20px 0 0',width:'100%',maxWidth:600,maxHeight:'92vh',overflowY:'auto',padding:'0 0 40px',border:'1px solid var(--border)',borderBottom:'none'}}>
        <div style={{display:'flex',alignItems:'center',gap:12,padding:'20px 24px 16px',borderBottom:'1px solid var(--border)'}}>
          ...
          <div style={{flex:1}}>
            ...
            <h2 style={{fontFamily:"'Cormorant Garamond',serif",fontSize:20,color:'var(--text-1)',fontWeight:700}}>{shop?.name}</h2>
          </div>
          ...
          {CATEGORIES.map(cat=>(
            <div key={cat.key} className="card" style={{padding:18,marginBottom:12}}>
              <div style={{display:'flex',alignItems:'center',gap:12,marginBottom:14}}>
                ...
                <div style={{flex:1}}>
                  <p style={{fontSize:14,fontWeight:700,color:'var(--text-1)'}}>{cat.label}</p>
  ...
  return (
    <div className="animate-slideUp" style={{position:'absolute',bottom:0,left:0,right:0,background:'var(--surface)',borderTop:'1px solid var(--border)',borderRadius:'20px 20px 0 0',maxHeight:'72vh',overflowY:'auto',zIndex:1000,padding:'0 0 32px'}}>
      ...
      <div style={{position:'relative',margin:'0 16px',borderRadius:14,overflow:'hidden'}}>
        ...
        {shop.visited&&<div style={{position:'absolute',top:10,right:10,background:'var(--crema)',color:'#FAF6F0',fontSize:11,fontWeight:700,padding:'4px 10px',borderRadius:20}}>✓ Visited</div>}
      ...
      <div style={{padding:'16px 20px 0'}}>
        <div style={{display:'flex',alignItems:'flex-start',justifyContent:'space-between',gap:12}}>
          <div>
            <h2 style={{fontFamily:"'Cormorant Garamond',serif",fontSize:22,fontWeight:700,color:'var(--text-1)',lineHeight:1.2}}>{shop.name}</h2>
    ...
    <div style={{position:'fixed',inset:0,background:'rgba(180,165,145,0.88)',display:'flex',alignItems:'center',justifyContent:'center',zIndex:9999,padding:24}}
      ...
      <div className="card animate-scaleIn" style={{width:'100%',maxWidth:480,maxHeight:'85vh',overflowY:'auto',padding:0}}>
        ...
        <div style={{padding:'24px 24px 20px',borderBottom:'1px solid var(--border)',display:'flex',alignItems:'center',gap:12}}>
          ...
          <div style={{flex:1}}>
            <h2 style={{fontFamily:"'Cormorant Garamond',serif",fontSize:22,fontWeight:700,color:'var(--text-1)'}}>@{friend.username}</h2>
          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:10,marginBottom:20}}>
            {[{label:'Visited',value:uniqueShops.length,icon:'📍'},{label:'Avg Taste',value:avgTaste,icon:'☕'},{label:'Avg Vibe',value:avgAmbiance,icon:'🌿'}].map(s=>(
              <div key={s.label} style={{background:'var(--surface-2)',borderRadius:12,padding:'12px 8px',textAlign:'center',border:'1px solid var(--border)'}}>
                ...
                <div style={{fontFamily:"'Cormorant Garamond',serif",fontSize:22,fontWeight:700,color:'var(--text-1)'}}>{s.value}</div>
...
function FriendsView({user,shops,onNeedAuth}) {
  ...
  return (
    <div style={{maxWidth:640,margin:'0 auto',padding:'32px 24px'}}>
      <h1 className="animate-fadeUp" style={{fontFamily:"'Cormorant Garamond',serif",fontSize:38,fontWeight:700,color:'var(--text-1)',marginBottom:6}}>Friends</h1>
      ...
      {tab==='friends'&&(
        loading?<Spinner/>:friends.length===0?(
          <div className="card" style={{padding:'48px',textAlign:'center'}}>
            ...
            <p style={{fontFamily:"'Cormorant Garamond',serif",fontSize:20,color:'var(--text-1)',marginBottom:8}}>No friends yet</p>
          ...
          <div key={f.id} className="card animate-fadeUp" style={{padding:'16px 18px',marginBottom:10,display:'flex',alignItems:'center',gap:14,animationDelay:`${i*0.06}s`}}>
            ...
            <div style={{flex:1}}>
              <h3 style={{fontFamily:"'Cormorant Garamond',serif",fontSize:18,fontWeight:700,color:'var(--text-1)'}}>@{f.profile?.username||'unknown'}</h3>
          ...
          {!searching&&searchResults.map((profile,i)=>{
            ...
            return (
              <div key={profile.id} className="card animate-fadeUp" style={{padding:'16px 18px',marginBottom:10,display:'flex',alignItems:'center',gap:14,animationDelay:`${i*0.06}s`}}>
                <div style={{width:44,height:44,borderRadius:14,background:'var(--crema-mid)22',border:'2px solid var(--crema-mid)',display:'flex',alignItems:'center',justifyContent:'center',fontSize:18,flexShrink:0}}>☕</div>
                <div style={{flex:1}}>
                  <h3 style={{fontFamily:"'Cormorant Garamond',serif",fontSize:18,fontWeight:700,color:'var(--text-1)'}}>@{profile.username}</h3>
    ...
    <>
      ...
      <nav style={{height:56,background:'var(--surface)',borderBottom:'1px solid var(--border)',display:'flex',alignItems:'center',justifyContent:'space-between',padding:'0 16px',flexShrink:0,gap:8}}>
        <div style={{display:'flex',alignItems:'center',gap:6,flexShrink:0}}>
          <span className="nav-wordmark-full" style={{fontFamily:"'Cormorant Garamond',serif",fontSize:20,fontWeight:700,fontStyle:'italic',color:'var(--text-1)'}}>Café Café</span>
          <span className="nav-wordmark-short" style={{display:'none',fontFamily:"'Cormorant Garamond',serif",fontSize:20,fontWeight:700,fontStyle:'italic',color:'var(--text-1)'}}>cc</span>
...
function NearbyView({shops,avgScores,userLocation,locationError,locationLoading,onRequestLocation,onSelect,onLog}) {
  ...
  return (
    <div style={{maxWidth:680,margin:'0 auto',padding:'32px 24px'}}>
      <h1 className="animate-fadeUp" style={{fontFamily:"'Cormorant Garamond',serif",fontSize:38,fontWeight:700,color:'var(--text-1)',marginBottom:6}}>Nearby</h1>
        ...
        <>
          ...
          <div className="card animate-fadeUp delay-100" style={{padding:'18px 20px',marginBottom:24}}>
            <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:14}}>
              <p style={{fontSize:14,color:'var(--text-1)',fontWeight:700}}>Search radius</p>
          ...
          <p style={{fontSize:13,color:'var(--text-3)',marginBottom:16}}><span style={{color:'var(--text-1)',fontWeight:700}}>{shopsWithDistance.length}</span> café{shopsWithDistance.length!==1?'s':''} within {radius} mile{radius!==1?'s':''}</p>
          {shopsWithDistance.length===0?(
            <div className="card" style={{padding:'48px',textAlign:'center'}}>
              <div style={{fontSize:40,marginBottom:12}}>🔍</div>
              <p style={{color:'var(--text-1)',fontSize:16,fontFamily:"'Cormorant Garamond',serif",marginBottom:6}}>No cafés in range</p>
  ...
  return (
    <div className="content-max-width" style={{maxWidth:680,margin:'0 auto',padding:'24px 24px'}}>
      ...
      {filtered.length===0?(
        <div className="card" style={{padding:'48px',textAlign:'center'}}>
          <div style={{fontSize:40,marginBottom:12}}>🔍</div>
          <p style={{color:'var(--text-1)',fontSize:16,fontFamily:"'Cormorant Garamond',serif",marginBottom:6}}>No cafés found</p>
          ...
          <div key={shop.id} className="card animate-fadeUp" style={{marginBottom:16,overflow:'hidden',cursor:'pointer',transition:'border-color 0.2s',animationDelay:`${i*0.06}s`}}
            ...
            <div style={{padding:'16px 20px'}}>
              <div style={{display:'flex',justifyContent:'space-between',alignItems:'flex-start'}}>
                <div>
                  <h3 style={{fontFamily:"'Cormorant Garamond',serif",fontSize:22,fontWeight:700,color:'var(--text-1)'}}>{shop.name}</h3>
  ...
  return (
    <div style={{height:'100vh',background:'var(--bg)',display:'flex',alignItems:'center',justifyContent:'center',padding:24}}>
      <div style={{background:'var(--surface)',border:'1px solid var(--border)',borderRadius:24,width:'100%',maxWidth:420,padding:'40px 32px'}}>
        ...
        {/* Heading */}
        <h1 style={{fontFamily:"'Cormorant Garamond',serif",fontSize:32,fontWeight:700,color:'var(--text-1)',marginBottom:8,lineHeight:1.1}}>
          One last thing
        </h1>
                      ...
                      <div style={{display:'flex',gap:10,alignItems:'center'}}>
                        ...
                        <div style={{flex:1,minWidth:0}}>
                          <div style={{display:'flex',alignItems:'center',gap:5}}>
                            <h3 style={{fontFamily:"'Cormorant Garamond',serif",fontSize:14,fontWeight:700,color:'var(--text-1)',overflow:'hidden',textOverflow:'ellipsis',whiteSpace:'nowrap'}}>{shop.name}</h3>
